'''
memoryvew is a view, not a copy of the byte buffer
'''
import code
...
def main():
    ...
    # from the previous prints of indexes and buffer values, we can see that buffer[21] = 3f
    # code.interact takes us to a repl and we can do:
    # >>> hex(mem[21])
    # '0x3f'
    # we can slice and also convert it to a list
    # >>> mem[12:18].cast('H').tolist()
    # [3040, 34423, 54321]        <-     color values for the first vertex 
