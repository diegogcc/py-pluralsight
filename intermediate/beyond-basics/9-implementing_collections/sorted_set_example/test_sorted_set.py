...
class TestSequenceProtocol(unittest.TestCase):
    ...
    ''' Index (solved through collections.abc module)'''
    ...
    ''' Count (solved through collections.abc module)'''
...
class TestConcatenationProtocol(unittest.TestCase):
...
class TestRepetitionProtocol(unittest.TestCase):
...
class TestInequalityProtocol(unittest.TestCase):
    ...
    def test_negative_unequal(self):
        self.assertFalse(SortedSet([4, 5, 6]) != SortedSet([5, 4, 6]))
