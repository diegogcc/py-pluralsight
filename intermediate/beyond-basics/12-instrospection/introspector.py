...
def full_sig(method):
    try:
        ...
        return method.__name + '(...)'

def brief_doc(obj):
    ''' Extracts first line of __doc__ '''
    doc = obj.__doc__
    if doc is not None:
...
if __name__ == "__main__":
    ...
    # File "/Users/campdi7/Documents/Diego/Projects/py-pluralsight/intermediate/beyond-basics/12-instrospection/instrospector.py", line 34, in dump
    #     for method in methods]
    # File "/Users/campdi7/Documents/Diego/Projects/py-pluralsight/intermediate/beyond-basics/12-instrospection/instrospector.py", line 34, in <listcomp>
    #     for method in methods]
    # File "/Users/campdi7/Documents/Diego/Projects/py-pluralsight/intermediate/beyond-basics/12-instrospection/instrospector.py", line 40, in full_sig
    #     return method.__name__ + inspect.signature(method)
    # TypeError: can only concatenate str (not "Signature") to str