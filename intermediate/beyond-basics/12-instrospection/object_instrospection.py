...
# '__xor__', 'bit_length', 'conjugate', 'denominator', 'from_bytes', 'imag', 'numerator', 'real', 
# 'to_bytes']

''' call 'denominator' attribute'''
>> getattr(i, 'denominator')            # 1
>> i.denominator                        # 1

''' calling 'conjugate' attr -> it's also a method '''
>> getattr(i, 'conjugate')              # <built-in method conjugate of int object at 0x1060b8fd0>
>> callable(getattr(i, 'conjugate'))    # True
''' attributes of objects and attributes of attributes '''
